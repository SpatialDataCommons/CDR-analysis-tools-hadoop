create table {provider_prefix}_frequent_locations_thresholded as select td3.uid as uid, td3.tcount
...
select uid, acc_wsum from  {provider_prefix}_freq_with_acc_wsum
